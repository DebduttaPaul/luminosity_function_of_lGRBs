...
def model_evolvingECPL( L_cut, coeff, delta, nu, chi, z1, z2 ):
	...
	for k, z in enumerate(z_sim):
		...
		print lower_limit, upper_limit, quad( f, lower_limit, upper_limit, args=(nu) )[0]
...
for j, z in enumerate( z_binned__Fermi[:-1] ):
	...
	model_bin__CZTI	=	model_evolvingECPL( L_cut__Fermi, coeff, delta, nu, chi, z, z_binned__Fermi[j+1] )
