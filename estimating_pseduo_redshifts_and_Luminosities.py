...
def estimate_pseudo_redshift_and_Luminosity__Fermi( flux, flux_error, Epeak_in_MeV, Epeak_in_MeV_error, alpha, beta ):
	...
	return flux, flux_error, Epeak_in_MeV, Epeak_in_MeV_error, pseudo_redshifts, pseudo_redshifts_error, Luminosity, Luminosity_error



def estimate_pseudo_redshift_and_Luminosity__Swift( flux, flux_error, Epeak_in_MeV, Epeak_in_MeV_error ):
...
Fermi_long_flux, Fermi_long_flux_error, Fermi_long_Epeak_in_MeV, Fermi_long_Epeak_in_MeV_error, Fermi_long_pseudo_redshift, Fermi_long_pseudo_redshift_error, Fermi_long_Luminosity, Fermi_long_Luminosity_error	=	estimate_pseudo_redshift_and_Luminosity__Fermi( Fermi_long_flux, Fermi_long_flux_error, Fermi_long_Epeak_in_MeV, Fermi_long_Epeak_in_MeV_error, Fermi_long_alpha, Fermi_long_beta )
...
Fermi_short_flux, Fermi_short_flux_error, Fermi_short_Epeak_in_MeV, Fermi_short_Epeak_in_MeV_error, Fermi_short_pseudo_redshift, Fermi_short_pseudo_redshift_error, Fermi_short_Luminosity, Fermi_short_Luminosity_error	=	estimate_pseudo_redshift_and_Luminosity__Fermi( Fermi_short_flux, Fermi_short_flux_error, Fermi_short_Epeak_in_MeV, Fermi_short_Epeak_in_MeV_error, Fermi_short_alpha, Fermi_short_beta )
...
Swift_long_flux, Swift_long_flux_error, Swift_long_Epeak_in_MeV, Swift_long_Epeak_in_MeV_error, Swift_long_pseudo_redshift, Swift_long_pseudo_redshift_error, Swift_long_Luminosity, Swift_long_Luminosity_error	=	estimate_pseudo_redshift_and_Luminosity__Swift( Swift_long_flux, Swift_long_flux_error, Swift_long_Epeak_in_MeV, Swift_long_Epeak_in_MeV_error )
print 'Number of GRBs selected		:	', Swift_long_flux.size

print '\n\n'
print '#### Swift short GRBs ####', '\n'
print 'Number of GRBs put in		:	', Swift_short_num, '\n'
Swift_short_flux, Swift_short_flux_error, Swift_short_Epeak_in_MeV, Swift_short_Epeak_in_MeV_error, Swift_short_pseudo_redshift, Swift_short_pseudo_redshift_error, Swift_short_Luminosity, Swift_short_Luminosity_error	=	estimate_pseudo_redshift_and_Luminosity__Swift( Swift_short_flux, Swift_short_flux_error, Swift_short_Epeak_in_MeV, Swift_short_Epeak_in_MeV_error )
...
L_vs_z__Fermi_long	=	Table( [ Fermi_long_pseudo_redshift,  Fermi_long_pseudo_redshift_error,  Fermi_long_Epeak_in_MeV*1e3,  Fermi_long_Epeak_in_MeV_error*1e3,  Fermi_long_Luminosity,  Fermi_long_Luminosity_error], names = [ 'pseudo z', 'pseudo z_error', 'Epeak (meas) [keV]', 'Epeak_error (meas) [keV]', 'Luminosity', 'Luminosity_error' ] )
L_vs_z__Fermi_short	=	Table( [Fermi_short_pseudo_redshift, Fermi_short_pseudo_redshift_error, Fermi_short_Epeak_in_MeV*1e3, Fermi_short_Epeak_in_MeV_error*1e3, Fermi_short_Luminosity, Fermi_short_Luminosity_error], names = [ 'pseudo z', 'pseudo z_error', 'Epeak (meas) [keV]', 'Epeak_error (meas) [keV]', 'Luminosity', 'Luminosity_error' ] )
L_vs_z__Swift_long	=	Table( [ Swift_long_pseudo_redshift,  Swift_long_pseudo_redshift_error,  Swift_long_Epeak_in_MeV*1e3,  Swift_long_Epeak_in_MeV_error*1e3,  Swift_long_Luminosity,  Swift_long_Luminosity_error], names = [ 'pseudo z', 'pseudo z_error', 'Epeak (siml) [keV]', 'Epeak_error (siml) [keV]', 'Luminosity', 'Luminosity_error' ] )
L_vs_z__Swift_short	=	Table( [Swift_short_pseudo_redshift, Swift_short_pseudo_redshift_error, Swift_short_Epeak_in_MeV*1e3, Swift_short_Epeak_in_MeV_error*1e3, Swift_short_Luminosity, Swift_short_Luminosity_error], names = [ 'pseudo z', 'pseudo z_error', 'Epeak (siml) [keV]', 'Epeak_error (siml) [keV]', 'Luminosity', 'Luminosity_error' ] )
...
#~ ascii.write( L_vs_z__Fermi_long , './../tables/L_vs_z__Fermi_long.txt' , format = 'fixed_width', overwrite = True )
#~ ascii.write( L_vs_z__Fermi_short, './../tables/L_vs_z__Fermi_short.txt', format = 'fixed_width', overwrite = True )
#~ ascii.write( L_vs_z__Swift_long , './../tables/L_vs_z__Swift_long.txt' , format = 'fixed_width', overwrite = True )
